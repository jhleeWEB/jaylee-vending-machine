...
## 추가 기능
- 제품이 품절 되면 버튼이 비활성화 되고 품절 표시합니다.

![item-soldout](https://github.com/user-attachments/assets/2a3bc262-79f2-4ec8-bc99-26b2d724c117)

- 모든 제품이 품절이면 현금 입력 및 카드 삽입이 불가능합니다.
- 상품 개수 표현됩니다.
- 현제 남은 잔액이 표현됩니다.
- 제품 선택 제한 시간이 표현됩니다.
- 현제 자판기 상태가 실시간으로 표현됩니다.
